...
const failMessage = `Hey, it's foggy and I had issues retrieving the weather. Try again later`;
...
const verifyCallback = (req, res) => {
    ...
    const hashToSend = crypto.createHmac('sha256', webhookSecret).update(JSON.stringify(bodyToSend)).digest('hex');
...
app.post('/webhook2', (req, res) => {
    ...
    const TWILIO_ACCOUNTSID = 'AC817cb3068b7bc6d67598d1df9d3619c0';
    const TWILIO_AUTHTOKEN = '5173cce5573d9a39020eb450f50b5a58';
    // const TWILIO_FROM='15005550006';
    const TWILIO_FROM = '+14842716999';
...
app.post('/webhook', validateEvent, (req, res) => {
    ...
    ////////////////////////////////////////////////////////////
    // TWILIO_ACCOUNTSID='AC37d1c2a25ad173e723f817cd3eab313a'
    // TWILIO_AUTHTOKEN='84c914f766fe165ad15ab4f927755c2d'
    // TWILIO_FROM='12045001730'
